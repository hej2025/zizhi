...
## 使用的Skill
- `.github/skills/cn_short_video_publisher/SKILL.md`

## 通用资源绑定
- 自动发布默认复用 `.github/resources/douyin_video_common/douyin_auto_publish.py`。
- 发布包默认对齐 `.github/resources/douyin_video_common/publish_package.template.json`。
