...
description: 飞书 CLI 全生命周期管理专家。负责安装、配置、认证、验证及使用场景指导。沉淀成个人操作手册，支持环境问题排查。
argument-hint: |
  操作类型（必选）：
...
tools: [vscode, execute, search, read, edit, 'feishu-lark/*', web, todo]
---
...
- **知识库**：.github/knowledge/lark_cli_manager/
