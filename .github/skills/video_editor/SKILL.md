...
## 共享枚举引用
> 本 Skill 使用的枚举值定义于 `.github/skills/_shared/enums.md`，包括 TransitionType、ShotType、VfxType、Emotion。
...
## 通用资源关联
- 当使用通用导出链路时，优先复用 `.github/resources/douyin_video_common/auto_finalize_generic.sh`。
